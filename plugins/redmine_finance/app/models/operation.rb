...
class Operation < ActiveRecord::Base
  ...
  attr_accessible :amount, :description, :account_id, :category_id, :operation_date, :is_approved, :contact_id, :assigned_to_id, :custom_field_values
  ...
  scope :income, lambda { joins(:category).where(:operation_categories => {:is_income => true}) }
  scope :expense, lambda { joins(:category).where(:operation_categories => {:is_income => false}) }
